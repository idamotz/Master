...
\begin{itemize}
  ...
  \item \textbf{moveFeature}(\var{featureID}, \var{targetGroupID}) at $t_n$ \todo{change example that deals with groups}\\
  ...
  \begin{figure}[h]
    \centering
      ...
      \textbf{Modified plan \todo{Make two different circles for two different scopes}}
