...
Define an algorithm or method for computing the difference between a base feature model B and derived model F. This eliminates the need to exc\todo{continue here ...}
