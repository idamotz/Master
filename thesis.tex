...
\chapter{A sound merging strategy for temporal feature models}%
\label{cha:solution}
...
\todo{maybe ref linholm or json merger, how this is not good enough as well. also use textual/syntactic/etc}
