...
\begin{lemma}
   The \emph{\rulefont{Add-Feature}} rule operates strictly within the scope of the \emph{\textbf{addFeature}} operation.
\end{lemma}
...
\begin{lemma}
   The \emph{\rulefont{{Add-Feature}}} rule preserves well-formedness of the temporal feature model.
\end{lemma}
...
\newpage \todo{This is to avoid cyclic re-compilation}
