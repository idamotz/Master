...
\begin{lemma}
   The \rulefont{Change-Feature-Name} rule preserves well-formedness of the temporal feature model. 
...
\begin{lemma}
   The \rulefont{Change-Feature-Name} rule updates the temporal feature model according to the semantics of the \textbf{changeFeatureName} operation.
