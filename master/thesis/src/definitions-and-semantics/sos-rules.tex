...
\begin{figure}[h]
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \lookup{\features{}}{\var{fid}} = \feature \\
...
\begin{figure}
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \\
        \\
        \qqquad \qqquad \forall \interval{t_{p_1}}{t_{p_2}} \in \overlapping{F_p}{t_n}{t_{t_2}} \hfill \\ % for all parent intervals overlapping the temporal scope
        \qqquad \qqquad \forall p \in F_p \interval{t_{p_1}}{t_{p_2}} \hfill \\% for all parent groups (always exactly one) in the parent interval
...
\begin{figure}
  \begin{minted}[escapeinside=||]{text}
getTypes|$\left(\group, \, \interval{t_n}{t_m} \right) = G_t \interval{t_n}{t_m}$|
getTypes|$\left(\feature, \, \interval{t_n}{t_m} \right) = G_t \interval{t_n}{t_m}$|
  \end{minted}
...
\begin{figure}
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \\
        \\
        \qqquad \qqquad \forall \interval{t_{c_1}}{t_{c_2}} \in \overlapping{G_c}{t_n}{t_{t_2}}\hfill\\ % for all parent intervals overlapping the temporal scope 
        \qqquad \qqquad\forall c \in \, \bigcup G_c \interval{t_{c_1}}{t_{c_2}}\hfill\\ % for all child features in the child interval
        \qqquad \qqquad\forall t \in \, \var{getTypes}\left(\lookup{\features}{c}, \clamp{\interval{t_{c_1}}{t_{c_2}}}{t_n}{t_{t_2}}\right)\hfill \\ % for all the types of the child features during the temporal scope
