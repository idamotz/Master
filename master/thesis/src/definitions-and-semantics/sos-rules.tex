...
\begin{figure}
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \qqquad \qqquad \forall p \in \lookup{F_p}{\interval{t_{p_1}}{t_{p_2}}} \hfill \\% for all parent groups (always exactly one) in the parent interval
...
\begin{figure}
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \qqquad \qqquad\forall c \in \, \bigcup \lookup{G_c}{\interval{t_{c_1}}{t_{c_2}}}\hfill\\ % for all child features in the child interval
