...
clampInterval|$\left( \map{map}, \, t_c \right)$|
  = let |$\left\set{\interval{t_{start}}{t_{end}}\right} \assign \containing{\map{map}}{t_c}$|
...
clampIntervalValue|$\left( \map{map}, \, t_c ,\, v\right)$|
  = let |$\left\set{\interval{t_{start}}{t_{end}}\right} \assign \containingvalue{\map{map}}{t_c}{v}$|
...
\begin{figure}
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \forall t_{\in \, \var{getTypes}\left(p, \clamp{\interval{t_{p_1}}{t_{p_2}}}{t_n}{t_{t_2}}\right)}
...
\begin{figure}
    ...
    \sossize$$\begin{array}{c}
      ...
      {\\
        ...
        \forall t_{\in \, \var{getTypes}\left(c, \clamp{\interval{t_{c_1}}{t_{c_2}}}{t_n}{t_{t_2}}\right)} % for all the types of the child features during the temporal scope
